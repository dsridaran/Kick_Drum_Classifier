...
def train_classifier(drum_path = '../data/raw/drum_samples_from_NN_training_set', kick_path = '../data/raw/kick_samples_from_NN_training_set', X_train_labs = None, x_percent = 1.0, type = "center", noise_factor = 0.0, verbose = False, epochs = 3, batch_size = 32, validation_split = 0.2, seed = 1, plot_cm = False):
    """
    ...
    X_train, X_test, y_train, y_test = split_data(X, y, X_labs, X_train_labs = X_train_labs)
